    ...
    <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex flex-stack ">
        ...
        <div class="d-flex align-items-center gap-2 gap-lg-3">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                <!--begin::Filter-->
                <button type="button" id="filter-0002-0001" class="btn btn-light-primary me-3" data-kt-menu-trigger="click"
            ...
            <!--end::Toolbar-->
            <button class="btn btn-light-primary fw-bold btn-primary btn-0002-0001">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-user-table-filter="search" id="search-0002-0001" class="form-control form-control-solid  ps-13" placeholder="Search user" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
